...
//    @PreAuthorize("isAuthenticated()")  // 인증된 사용자만 접근 가능...
    ...
    public void CeoRead(String ceoId, Model model) {
        CeoDTO ceoDTO = updateService.readOne(ceoId);
        log.info(ceoDTO);
    ...
    public void cusRead(String cusId, Model model) {
        CustomerDTO customerDTO = updateService.readOne2(cusId);
