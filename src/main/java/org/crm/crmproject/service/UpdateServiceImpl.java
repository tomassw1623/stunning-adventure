...
//            Optional<CeoMember> result = ceoMemberRepository.findByCeoId(ceoDTO.getGm());
//
...
//        Optional<CustomerMember> result = customerMemberRepository.findByCusId(customerDTO.getUser());
//
